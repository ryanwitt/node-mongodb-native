...
const DropCollectionOperation = require('./operations/drop_collection');
const DropDatabaseOperation = require('./operations/drop_database');
...
Db.prototype.command = function(command, options, callback) {
  ...
  const commandOperation = new CommandOperation(this, command, options);

  return executeOperationV2(this.s.topology, commandOperation, callback);
};
...
Db.prototype.createCollection = deprecateOptions(
  ...
  function(name, options, callback) {
    ...
    return executeOperationV2(this.s.topology, createCollectionOperation, callback);
  }
);
...
Db.prototype.stats = function(options, callback) {
  ...
  const statsOperation = new CommandOperation(this, commandObject, options);
...
Db.prototype.dropCollection = function(name, options, callback) {
  ...
  const dropCollectionOperation = new DropCollectionOperation(this, cmd, opts);

  return executeOperationV2(this.s.topology, dropCollectionOperation, callback);
};
...
Db.prototype.dropDatabase = function(options, callback) {
  ...
  const dropDatabaseOperation = new DropDatabaseOperation(this, cmd, finalOptions);

  return executeOperationV2(this.s.topology, dropDatabaseOperation, callback);
};
...
Db.prototype.collections = function(options, callback) {
  ...
  return executeOperationV2(this.s.topology, collectionsOperation, callback);
};
...
Db.prototype.executeDbAdminCommand = function(selector, options, callback) {
  ...
  return executeOperationV2(this.s.topology, executeDbAdminCommandOperation, callback);
};
...
Db.prototype.addUser = function(username, password, options, callback) {
  ...
  return executeOperationV2(this.s.topology, addUserOperation, callback);
};
...
Db.prototype.removeUser = function(username, options, callback) {
  ...
  return executeOperationV2(this.s.topology, removeUserOperation, callback);
};
...
Db.prototype.setProfilingLevel = function(level, options, callback) {
  ...
  return executeOperationV2(this.s.topology, setProfilingLevelOperation, callback);
};
...
Db.prototype.profilingLevel = function(options, callback) {
  ...
  return executeOperationV2(this.s.topology, profilingLevelOperation, callback);
};
